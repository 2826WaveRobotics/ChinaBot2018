...
Intake::Intake() : frc::Subsystem("Intake") {
    ...
    openIntake = RobotMap::intakeOpenIntake;
    intakeSwitch = RobotMap::intakeIntakeSwitch;
...
void Intake::openIntakeClaw(bool open) {
	openIntake.get()->Set(open);
}
...
bool Intake::CheckIntake(){
	return intakeSwitch.get()->Get();
}
